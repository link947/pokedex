...
function renderModalContent(pokemon) {
    ...
    const regularImage = pokemon.image;
    ...
    return /*HTML*/`
        ...
        <img class="modal-img" src="${gifImage}" alt="${pokemon.name}" onerror="this.onerror=null; this.src='${regularImage}';">
        <div class="modal-nav-buttons">
            <button id="prev-section-btn" class="pixel-corners-2" onclick="showStatsSection()" style="opacity: .5;" disabled>
                <img src="assets/icons/stats-icon.png" alt="">
            </button>
            <button id="next-section-btn" class="pixel-corners-2" onclick="showInfoSection()">
                <img src="assets/icons/i-icon.png" alt="">
            </button>
        </div>
        ${renderTypeIcons(pokemon)}
                ...
                <div class="stats">
                    <div class="statbar-container">
                        ...
                        <div class="custom-progress-bar pixel-corners-2">
                            <div class="custom-progress-bar-fill" style="width: 0%;" id="hp-bar"></div>
                        </div>
                    </div>
                    <div class="statbar-container">
                        <span class="pixel-corners-2">Attack</span>
                        <div class="custom-progress-bar pixel-corners-2">
                            <div class="custom-progress-bar-fill" style="width: 0%;" id="attack-bar"></div>
                        </div>
                    </div>
                    <div class="statbar-container">
                        <span class="pixel-corners-2">Defense</span>
                        <div class="custom-progress-bar pixel-corners-2">
                            <div class="custom-progress-bar-fill" style="width: 0%;" id="defense-bar"></div>
                        </div>
                    </div>
                </div>
            </div>
